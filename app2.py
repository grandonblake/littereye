...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_5.addWidget(self.StartRecordButton)
        ...
        self.topFrameLayout.setStretch(0, 2)
        self.topFrameLayout.setStretch(1, 8)
        ...
        self.label_2 = QLabel(self.centerLeftFrame)
        ...
        self.label_8 = QLabel(self.centerLeftFrame)
        ...
        self.label_5 = QLabel(self.centerLeftFrame)
        ...
        self.label_7 = QLabel(self.centerLeftFrame)
        ...
        self.listWidget_2 = QListWidget(self.centerCenterFrame)
        ...
        self.listWidget_3 = QListWidget(self.centerCenterFrame)
        self.listWidget_3.setObjectName(u"listWidget_3")

        self.verticalLayout_14.addWidget(self.listWidget_3)
        ...
        self.label_11 = QLabel(self.centerRightFrame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Line Chart showing total detected litter per day on a span of a date", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"Amount of Total Detected Litter per class (Bar chart)", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Percentage Distribution of Total Detected Litter per class (Pie chart)", None))
